    ...
    def _get_zmq_addresses(parallel_config: ParallelConfig,
        ...
        if local_engine_count == dp_size or spmd_mode:
            if platform.system() == "Windows":
                input_address = "tcp://127.0.0.1:45974"
                output_address = "tcp://127.0.0.1:45975"
            else:
            ...
            if platform.system() == "Windows":
                input_address = "tcp://127.0.0.1:" + str(input_port)
                output_address = "tcp://127.0.0.1:" + str(output_port)
            else:
